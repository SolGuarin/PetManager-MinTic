 ...
 * @author Usuario
 */
public class cslPet implements IAnimal, IVertebrate {
    private String code;
    private String name;
    private int bornYear;
    private String color;
    private String healthStatus;
    private cslVeterinary veterinary;

   

    public cslPet(String code, String name, int bornYear, String color, String healthStatus) {
        this.code = code;
        this.name = name;
     ...
     */
    public cslVeterinary getVeterinary() {
        return veterinary;
    }
     ...
     */
    public void setVeterinary(cslVeterinary veterinary) {
